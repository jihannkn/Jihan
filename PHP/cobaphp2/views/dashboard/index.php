    ...
    <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/cobaphp2/views/dashboard/">
                            <i class="bi bi-house"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/cobaphp2/views/dashboard/articles/">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-bold mb-0">100 - Article</span>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-bold mb-0">7 - Writer</span>
                                    </div>
                                    <div class="col-auto">
